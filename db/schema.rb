...
ActiveRecord::Schema[7.1].define(version: 2023_12_03_204416) do
  ...
  create_table "request_for_consultations", force: :cascade do |t|
    t.bigint "patient_id", null: false
    t.text "request_text"
    t.date "creation_date"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["patient_id"], name: "index_request_for_consultations_on_patient_id"
  end

  add_foreign_key "consultation_requests", "patients"
  add_foreign_key "recommendations", "consultation_requests"
  add_foreign_key "request_for_consultations", "patients"
end
